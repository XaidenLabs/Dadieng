  ...
  return (
    <footer>
      <div className="container footer-grid">
        ...
        <nav aria-label="Footer navigation"><Link to="/docs">Documentation</Link><a href="https://dadieng-console.dadiengalfred.chatgpt.site">Console</a><a href="mailto:hello@dadieng.dev">Contact</a></nav>
      </div>
